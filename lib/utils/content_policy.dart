...
class ContentPolicy {
  ...
  // 정신 건강 관련 민감한 키워드 (리소스 제공용)
  static final List<String> mentalHealthKeywords = [
    '자살', '자해', '죽고 싶', '사라지고 싶', '끝내고 싶',
    '우울', '불안', '공황', '자해하고', '자살하고',
    '죽으면', '죽어버리',
  ];
  
  // 도움 리소스 정보
  static const String mentalHealthResources = '''
━━━━━━━━━━━━━━━━━━━━
⚠️ 도움이 필요하신가요?
